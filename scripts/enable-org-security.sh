...
# Macie and Detective were enabled during the initial org build but neither
# feeds the CloudSentinel pipeline, which ingests GuardDuty, Security Hub and
# Inspector. Both were measured and removed rather than left running; see
# docs/adr/0004 for the same reasoning applied to OpenSearch.
